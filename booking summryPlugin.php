					...
					<h2>Ride Details</h2>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input name="passportId" type="text" class="form-control" value="">
							</div>	
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input name="pickupdate" type="date" class="form-control" value="">
							</div>
							<div class="col-md-6">
								<label>Pick Up Time:</label>
								<input name="pickuptime" type="text" class="form-control" value="">
							</div>	
						</div>
						...
						<!-- <div class="row" style="margin-top: 40px;">
							<div class="col-md-12">
								...
								<textarea name="comments" rows="5" cols="50" value="">
								</textarea>
							</div>
						</div> -->
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input name="pickUpLocation" type="text" class="form-control" value="">
							</div>
							<div class="col-md-6">
								<label>Drop Of Location:</label>
								<input name="dorpOffLocation" type="text" class="form-control" value="">	
							</div>
				...
				<div class="col-md-4">
					<h1 class="display-4">Payment Details</h1>
						...
						<div class="custom-control custom-radio">
							...
							<input name="payment" type="text" class="form-control" value="">
						</div>
				...
				<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<input name="pasengers" type="text" class="form-control" value="">

							<label>Number Of Suitcases:</label>
							<input name="suitcases" type="text" class="form-control" value="">
	...
	<!-- button -->
			<div class="row">
				...
				<div class="col-md-2">
						...
						<input type='button' onclick="window.location.replace('http://yayataxis.com/my-booking-info/?preview_id=610&preview_nonce=89dc59ce02&preview=true')" value='Cancle'>	
